...
class Downloader extends Component {
	...
	getDownloadSource = (data) => {
		let url;
		const confirmed = window.confirm("Download file with metadata?\nArtist name, Track name, Year and Cover Art will be embedded into The file.");
		...
		if (confirmed) {
			...
			url = this.context.getPreferredQualityURL(data.sources);
		}
