			...
			<section className="fade_in_up min-h-0 grow w-full overflow-y-auto px-4 md:px-8 lg:px-12 pt-4 pb-[65px]">
				<figure className="w-full flex flex-col justify-center items-center">
					...
					<figcaption className="mt-4 text-center">
						<h2 className="text-2xl text-neutral-800 font-medium mb-1">{specificAlbumDetails.name}</h2>
						<p className="text-sm text-neutral-600 font-normal">{specificAlbumDetails.description}</p>
				...
				<div className="w-full max-w-lg mt-8 mb-4 mx-auto">
					<h3 className="text-lg font-normal text-neutral-600">More about {specificAlbumDetails.name}</h3>
					<div className="mt-3">
						...
						<h4 className="text-base font-normal mb-2">Songs</h4>
