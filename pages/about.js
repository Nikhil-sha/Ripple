		...
		return (
			<Fragment>
				<article className="mb-8 max-w-lg mx-auto">
					<h1 className="text-xl font-extrabold text-neutral-100 leading-snug mb-2"><i className="text-md fas fa-hand text-yellow-400 mr-2.5"></i>Welcome to Ripple!</h1>
				...
				<article className="max-w-lg mx-auto">
					<h2 className="text-lg font-bold text-neutral-200 leading-snug mb-4"><i className="w-6 text-left text-md fas fa-clipboard text-neutral-400"></i>ChangeLog</h2>
					<div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.3.0 (current - stable)</h3>
					...
					<div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.2.1</h3>
				 	<ol className="border-l-2 border-yellow-400 text-neutral-400 flex flex-col gap-2 list-decimal list-inside text-xs px-3">
					...
					<div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.2.0</h3>
				 	<ol className="border-l-2 border-yellow-400 text-neutral-400 flex flex-col gap-2 list-decimal list-inside text-xs px-3">
					...
					<div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.1.3 (stable)</h3>
				 	<ol className="border-l-2 border-yellow-400 text-neutral-400 flex flex-col gap-2 list-decimal list-inside text-xs px-3">
				 		<li>Changed Home page layout.</li>
				 	</ol>
					</div>
					<div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.1.2</h3>
				 	<ol className="border-l-2 border-yellow-400 text-neutral-400 flex flex-col gap-2 list-decimal list-inside text-xs px-3">
				 		<li>Highlight current track in player.</li>
				 	</ol>
					</div>
					<div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.1.1</h3>
				 	<ol className="border-l-2 border-yellow-400 text-neutral-400 flex flex-col gap-2 list-decimal list-inside text-xs px-3">
					...
					<div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.1.0</h3>
				 	<ol className="border-l-2 border-yellow-400 text-neutral-400 flex flex-col gap-2 list-decimal list-inside text-xs px-3">
				 ...
				 <div className="mb-4">
				 	<h3 className="text-md font-bold text-neutral-200 leading-snug mb-3">Ver. 2.0.0</h3>
				 	<ol className="border-l-2 border-yellow-400 text-neutral-400 flex flex-col gap-2 list-decimal list-inside text-xs px-3">
